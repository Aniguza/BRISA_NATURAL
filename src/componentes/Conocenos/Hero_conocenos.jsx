    ...
    <div className="hero bg-extra h-full py-3 md:p-10 lg:px-45 lg:py-15 xl:px-70">
      <div className="hero-content flex-row-reverse md:gap-7">
        ...
        <div className="pl-5 pr-3">
          <h1 className="text-xs font-bold text-secondario md:text-lg lg:text-2xl">NUESTRA HISTORIA</h1>
          <p className="py-3 text-justify text-[8px] leading-3 text-texto texto_cono">
